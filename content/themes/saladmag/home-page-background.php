<?php
/*
  Template Name: Home page background slider
 */
?>
...
<?php if ( has_post_thumbnail()) {the_post_thumbnail('feature-grid');}
    ...
    <?php $slider_header_background = of_get_option('slider_header_background'); 
	if($slider_header_background){?>
    <img class="slider_background_img" src="<?php echo $slider_header_background;?>"/>
    <?php }?>

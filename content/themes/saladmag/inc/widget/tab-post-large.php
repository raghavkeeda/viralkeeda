...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            'classname' => 'clearfix',
            'description' => __('Display Hover large post in tab by select category work in menu and widget', 'jelly_text_main')
        );
        parent::__construct('tab-post-large-widget', __('jellywp: Hover tab post large Widget', 'jelly_text_main'), $widget_ops);
    }

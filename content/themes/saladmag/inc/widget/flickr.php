...
/*-----------------------------------------------------------------------------------*/
	...
	function __construct() {
		$widget_ops = array('classname' => 'ht_flickr_widget', 'description' => __( 'Images from Flickr.', 'jelly_text_main') );
		parent::__construct('flickr_widget', __('jellywp: Flickr', 'jelly_text_main'), $widget_ops);
...
/*-----------------------------------------------------------------------------------*/
	...
	<?php _e('Title:', 'jelly_text_main'); ?></label>
	...
	<?php _e('Flickr ID', 'jelly_text_main'); ?></label>
	...
	<?php _e('Number:', 'jelly_text_main'); ?></label>

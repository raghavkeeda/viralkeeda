...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => __('Tab widget: Popular, latest and comment.', 'jelly_text_main')
        );
        parent::__construct('triple-posts', __('jellywp: Tab widget', 'jelly_text_main'), $widget_ops);
    }
...
/*-----------------------------------------------------------------------------------*/
    ...
    function widget($args, $instance) {
        ...
        <div  id="tabs" class="widget_container">    
            ...
            <!--tabs-nav -->
            <ul class="tabs">
                <li class="active"><a class="title" href="#tab1"><?php _e('Popular', 'jelly_text_main'); ?></a></li>
                <li><a class="title" href="#tab2"><?php _e('Recent', 'jelly_text_main'); ?></a></li>
               <?php if ($show_comment_tab == true) { ?> <li><a class="title" href="#tab3"><?php _e('Comments', 'jelly_text_main'); ?></a></li><?php }?>
            </ul>
            <!-- end tabs-nav -->
...
<?php echo total_score_post_front(get_the_ID());?>
   ...
   <div class="clearfix"></div>
            ...
            <?php 
                ...
                foreach($comments as $comment) :
                      ...
                      <li class="tab-content-class">
							<a  class="feature-image-link" href="<?php echo $commenturl; ?>"><?php echo get_avatar( $comment, '80' ); ?></a>
                             <div class="item-details">
									 <h3 class="feature-post-title"><a class="post-title" href="<?php echo $commenturl; ?>"><?php echo $commentauthor; ?></a></h3>
									<p class="post-meta meta-list-small">
                                    <span class="post-date"><?php echo $commentcontent; ?></span>
                                        </p>
                                    </div>
						</li>
            <?php endforeach; ?>
 ...
 <p>
			...
			<label for="<?php echo $this->get_field_id('show_comment_tab'); ?>"><?php _e( 'Show comment tab', 'jelly_text_main'); ?></label>
		</p>

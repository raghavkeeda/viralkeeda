...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        ...
        parent::__construct('home-main-post-style', __('jellywp: main post images', 'jelly_text_main'), $widget_ops);
    }
        ...
        while ($jellywp_widget->have_posts()) {
            ...
            if ($i == 1) {
                ?>   
                   ...
                   <div class="two-content-wrapper <?php if(!of_get_option('disable_css_animation')==1){echo "appear_animation";}?>">

...
class home_post_grid_medium extends AQ_Block {
    ...
    <div class="feature-two-column medium-two-columns <?php if(!of_get_option('disable_css_animation')==1){echo "appear_animation";}?> <?php if($row_count % 2 != 0){echo 'margin-left-post';}?>">     

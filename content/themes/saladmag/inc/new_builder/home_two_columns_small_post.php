<?php
class home_small_post_two_columns extends AQ_Block {
	
	//set and create block
	function __construct() {
		$block_options = array(
			'name' => 'Home small post two columns',
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('home_small_post_two_columns', $block_options);
	}
...
?>
        ...
        <div class="widget two-post-style">
